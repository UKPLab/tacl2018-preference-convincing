...
## crowdBT
#OMP_NUM_THREADS=8 python3 -u python/analysis/habernal_comparison/personalised_tests.py 9 8000 
...
#
## crowdGPPL consensus
OMP_NUM_THREADS=8 python3 -u python/analysis/habernal_comparison/personalised_tests.py 1 8000
## crowdGPPL personalised
#OMP_NUM_THREADS=36 python3 python/analysis/habernal_comparison/personalised_tests.py 0
#
## GPPL consensus
OMP_NUM_THREADS=8 python3 -u python/analysis/habernal_comparison/personalised_tests.py 7 8000
