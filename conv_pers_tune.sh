...
### personalised
OMP_NUM_THREADS=24 python3 -u python/analysis/habernal_comparison/personalised_tests.py 13 0 20

OMP_NUM_THREADS=24 python3 -u python/analysis/habernal_comparison/personalised_tests.py 13 0 15
