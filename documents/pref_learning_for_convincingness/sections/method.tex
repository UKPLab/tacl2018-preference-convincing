...
\todo{Summarise this whole section in a paragraph or two. Move some background detail from previous section to here. OR just make it more argument-focused. Where to put in the 
linguistic features etc?}
...
To provide an inference algorithm that scales with the number of 
...
For SVI, we assume $M$ \emph{inducing points},% with feature s $\bs x_m$. 
...
We use a kernel function of the standard form 
