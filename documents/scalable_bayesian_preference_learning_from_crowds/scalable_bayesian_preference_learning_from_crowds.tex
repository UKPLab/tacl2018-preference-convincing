...
%Gaussian processes to integrate user and instance features. By taking a Bayesian approach, our model
...
%that can scale to large numbers of instances, users, and pairwise labels 
