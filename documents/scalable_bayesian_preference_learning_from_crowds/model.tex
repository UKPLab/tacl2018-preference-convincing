...
\begin{flalign}
p\left( \bs{y}, \bs V, \bs W, \bs t, s_1, ..., s_C, \sigma_t | k_{\theta}, k_{\eta}, \alpha_0, \beta_0 \right) 
= \prod_{p=1}^P \Phi\left( z_p \right) 
\mathcal{N}(\bs t; \bs 0, \bs K_{\theta} /\sigma_t)
 && \nonumber \\ 
\mathcal{G}({\sigma_t}; \alpha_0, \beta_0)\prod_{c=1}^C \left\{
\mathcal{N}(\bs v_c; \bs 0, \bs K_{\theta} /s_c) 
\mathcal{N}(\bs w_c; \bs 0, \bs K_{w,\eta}) \mathcal{G}(s_c; \alpha_0, \beta_0) \right\}, 
