...
\subfloat[Consensus]{
\label{fig:simB}
\includegraphics[width=.317\columnwidth,clip=true,trim=15 0 13 0]{tau_test}
}
\subfloat[Personal preferences]{
\label{fig:simC}
\includegraphics[width=.310\columnwidth,clip=true,trim=22 0 14 0]{tau_test_personal}
}
