...
\hline
 ...
 GPPL %medi. 
  & .76 & .51 & .48 & .71 &  \textbf{.56} & .32 & .72 & .55 & .26 \\ % .71 & .56 & .32 \\ % now showing with > 40 training examples
 ...
 crowdGPPL %medi. 
 & \textbf{.78} & \textbf{.50} & \textbf{.53} & \textbf{.73} & .60 & \textbf{.33} & \textbf{.74} & .58 & \textbf{.29}  \\ %.71 & .59 & .32 \\ % now showing workers with > 40 training examples
 % new values since Q and various minor bugfixes (Qfix1): 
 % .77 & .67 & .52 & .72 & .60 & .33 \\
 ...
 %GPC & .73 & .53 & - & .68 & .59 & - \\
 crowdBT-GP & .77 & .52 & .50 & .69 & .58 & .30 & .70 & \textbf{.57} & .24
 \\ \bottomrule
\end{tabular}
%}
...
\caption{
    Wall-clock times for training+prediction of consensus function 
    on UKPConvArgCrowdSample. 300 GloVe features. Means over 32 runs. CrowdGPPL with 5 components.
    The 
}
\end{figure}
