...
\label{fig:simB}
\includegraphics[width=.35\columnwidth]{../../results/synth_3/multi_user_consensus/tau_test}
} \\
\subfloat[Inferring personal preferences for members of a crowd]{
\label{fig:simC}
\includegraphics[width=.4\columnwidth]{../../results/synth_3/multi_user_personal/tau_test}
}
