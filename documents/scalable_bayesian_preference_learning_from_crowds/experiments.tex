...
\caption{
Distribution of latent factor variances, $1/s_c$, for crowdGPPL on 
\emph{UKPConvArgCrowdSample} and \emph{Sushi-A}, averaged over all runs.
\todo{be specific about which setup?}
}
