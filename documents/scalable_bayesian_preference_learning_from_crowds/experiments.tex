...
$\alpha_0 = 1$, $\beta_0 = 100$ and, for crowdGPPL, $C=25$.
...
The hyperparameters were set to $\alpha_0 = 2$, $\beta_0 = 200$ by comparing
training set accuracy against $\alpha_0=2, \beta_0 = 20000$ and $\alpha_0 = 2, \beta_0 = 2$.
We set $C=50$ and did not optimize this value.
...
and $\alpha_0=1, \beta_0=100$ using a grid search over values 
...
\multicolumn{1}{|b{1.1cm}|}{crowd-GPPL} & .67 & .87 & .39 & 77%76.91 %(27.23) %& .63 (.02) & .69 (.00) & .25 (.02)
...
whose model comprised a GP for each user and matrix factorization (CEE=0.69 on Sushi-B),
 as well as \citet{salimans2012collaborative}, using matrix factorization with no user or item features (Kendall's tau=0.39 on Sushi-B). 
