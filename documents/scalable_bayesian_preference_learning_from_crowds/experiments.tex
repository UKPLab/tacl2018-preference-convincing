...
\label{tab:datasets}
\end{table}
\todo{ Page 12, Section 5.  Can you provide a web reference to data sources (not just papers that use them)?}
...
\multicolumn{1}{|b{1.1cm}|}{crowd-GPPL} & .68 & .03 & .39 & 38%76.91 %(27.23) %& .63 (.02) & .69 (.00) & .25 (.02)
%old results from submission: & .79 & .51 & .66 & 60 %149.6 %(20.86)
%new results 02.04: 
& .81 & .39 & .66 & 21
& .73 & .57 & .47 & 4724 \\
%& \textbf{.79} & \textbf{.57} & .50 & 393 \\
% april rerun:
% .72 & .60 & .45 & 4706 % --> too many iterations? or do i need to divide by 25?
...
% new results 02.04
& .84 & .33 & .79 & 39
% old results from submission: & .84 & \textbf{.33} & .79 & 646 %(50.17) 
& - & - & - & -
\\
...
%old results from submission & .84 & \textbf{.33} & \textbf{.80} & 95 %(4.93)
& .78 &\textbf{.57} & .49 & 3788 \\
...
%old results from submission: & \textbf{.85} & \textbf{.33} & \textbf{.80} & 89 %(12.12)
%new results 02.04: 
\textbf{.85} & .33 & .80 & 14
& .77 & .58 & .48 & 3363
...
%old results from submission & .84 & \textbf{.33} & .79 & 204 %(12.15) 
%new results 02.04:
& .84 & .33 & .80 & 230
& .76 & .61 & .54 & 12513
...
% old results from submission: & .66 & .62 & .32 & \textbf{6} %(.38) & 
% new results 02.04:
& .65 & .62 & .31 & \textbf{2}
& .65 & .62 & .31 & \textbf{51}
\\
GPPL-per-user & .67 & .64 & .42 & 183 %(1.12) %& .50 (.00) & .69 (.00) & nan (nan)
%old results from submission & .83 & .40 & .79 & 1106 
% new results 02.04:
& .83 & .40 & .79 & 44
& .75 & .60 & \textbf{.60} & 3172 %(.44)
\\
collabGP & .69 & .58 & n/a & \textbf{2}* & .83 & .35 & n/a & 6* & .76 & .49 & n/a &  1283* \\
%\textbf{.81} & \textbf{.40} & n/a & 761 \\
\hline
%\citet{houlsby2012collaborative} CP & & & & & .84 \\
%\citet{houlsby2012collaborative} CPU & & & & & .83 \\ 
%\citet{khan2014scalable} & &&& & & & & & .69 & &
%\\ \hline
crowdGPPL$\backslash u, C=50$ & & & & & .83 & .34 & .78 & 
\end{tabularx}
\caption{Predicting personal preferences: performance on \emph{Sushi-A} dataset and \emph{Sushi-B} datasets.
Runtimes are means in seconds over $25$ repeats given. The runtimes for \emph{collaborative GP} are marked
with a star as these methods were implemented using \emph{R} and \emph{C} libraries,
which contributed to their faster runtimes over the other methods, which were implemented using \emph{Python 3}.
