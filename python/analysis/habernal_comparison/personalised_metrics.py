...
if __name__ == '__main__':
    ...
    # single - user methods were already included in the TACL paper so
    # can be copied from there.
    #
    # datasets =['UKPConvArgCrowdSample_evalMACE']
    # methods =['SinglePrefGP_noOpt_weaksprior', 'SingleGPC_noOpt_weaksprior', 'SVM', 'Bi-LSTM']#, 'SinglePrefGP_weaksprior']
    # feature_types =['both']  # 'both'
    # embeddings_types =['word_mean']
    #
    # results_f1, results_acc, results_auc, results_logloss, results_pearson, results_spearman, results_kendall, \
    ...
    #
    # datasets = ['UKPConvArgCrowdSample_evalMACE']
    # methods = ['PersConsensusPrefGP_commonmean_noOpt_weaksprior', 'PersConsensusPrefGP_commonmean']
    # feature_types = ['both'] # 'both'
    # embeddings_types = ['word_mean']
    #
    # results_f1, results_acc, results_auc, results_logloss, results_pearson, results_spearman, results_kendall, \
