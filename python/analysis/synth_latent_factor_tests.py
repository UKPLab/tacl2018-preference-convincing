...
if __name__ == '__main__':
    ...
    figure_save_path = figure_root_path + '/multiuser_factor_correlations/'
    ...
    for Nfactors in Nfactor_values:
        ...
        for s in inverse_scales:
            ...
            for rep in range(nreps):
                ...
                unassigned_f = np.arange(Nfactors)  # list of true factors that have not yet been matched to a predicted factor
        ...
        noise_plots[0] = plot_result(1, 'noise_r', 'noise rate in pairwise training labels',
                             "Mean factor correlation (Pearson's r)", 'num_factors=%i' % Nfactors, noise_plots[0])
    ...
    for Nfactors in Nfactor_values:
        ...
        noise_plots[1] = plot_result(2, "num_pairs_r", 'number of pairwise training labels',
