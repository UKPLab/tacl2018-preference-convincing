...
class GPPrefPerUser():
    ...
    def __init__(self, Npeople, max_update_size, shape_s0, rate_s0):
        self.user_models = []
        self.Npeople = Npeople
        for p in range(Npeople):
            model_p = GPPrefLearning(2, mu0=0, shape_s0=shape_s0, rate_s0=rate_s0, ls_initial=None, use_svi=True, ninducing=50,
    ...
    def predict_f(self, item_features, _):

        fpred = []

        for u in range(self.Npeople):
    ...
    def predict(self, users, p1, p2, item_features, _):
        ...
        for u in uusers:
            ...
            rhopred[uidxs] = rho_pred_u
            varrhopred[uidxs] = var_rho_pred_u
