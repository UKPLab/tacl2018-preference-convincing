...
#  run the script
python -u python/analysis/habernal_comparison/clean_data_tests.py
python -u python/analysis/habernal_comparison/clean_data_metrics.py
python -u python/analysis/habernal_comparison/features.py
python -u python/analysis/habernal_comparison/error_analysis.py
